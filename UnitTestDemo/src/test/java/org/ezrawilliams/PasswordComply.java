...
public class PasswordComply {
    ...
    static final String DB_URL = "jdbc:mysql://localhost:3307/PERSCHOLAS";
    ...
    public boolean doesNotAlreadyExist() throws SQLException {
        ...
        if(existingPassword.equals(passwordString)) {
            System.out.println("Password already exists: " + existingPassword);
            return false;
        }
    ...
    public boolean doesPasswordComply() {
        ...
        return verifyPasswordLength() && verifyAplhaNumeric() && hasAllowedSpecialCharacters() && hasNoSpecialCharacters();
    }
